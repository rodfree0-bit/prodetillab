 ...
 */
exports.sendInactivityReminders = functions.scheduler.onSchedule({
    schedule: '0 9 * * 1',
    ...
    try {
        ...
        const clientLastOrderDateMap = new Map();
        ...
        usersSnapshot.forEach(doc => {
            ...
            const wantsReminders = ((_a = user.notificationPreferences) === null || _a === void 0 ? void 0 : _a.reminders) !== false;
...
//# sourceMappingURL=scheduledInactivityReminders.js.map